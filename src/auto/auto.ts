...
setInterval(() => {
  ...
  ((i) => {
    get(
      "https://wscats.gallery.vsassets.io/_apis/public/gallery/publisher/Wscats/extension/qf/6.8.62/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage?redirect=true&install=true",
      {
        headers: {
          // ":method": "GET",
