...
var packageJson = {
  ...
  "badges": [{
    ...
    "href": "https://marketplace.visualstudio.com/items?itemName=Wscats.eno",
  ...
  "keywords": ["sass", "beautify", "scss", "typescript", "ts", "less", "stylus", "ES6", "ES5", "JS", "css", "javascript", "html", "compile", "translate", "tsx", "jade", "hero", "close", "port", "pug", "easysass", "easy", "super", "minified", "format", "json", "formatter", "formate"],
  "activationEvents": ["onLanguage:less", "onLanguage:scss", "onLanguage:sass", "onLanguage:jade", "onLanguage:pug", "onLanguage:stylus", "onLanguage:javascript", "onLanguage:javascriptreact", "onLanguage:typescript", "onLanguage:typescriptreact", "onCommand:compile-hero.openInBrowser", "onCommand:compile-hero.closePort", "onCommand:compile-hero.compileFile", "onCommand:compile-hero.compileSelected", "onCommand:compile-hero.compileHeroOn", "onCommand:compile-hero.compileHeroOff", "onCommand:compile-hero.beautify", "onCommand:compile-hero.beautifyFile"],
